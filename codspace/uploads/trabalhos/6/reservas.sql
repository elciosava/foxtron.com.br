...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `reservas_ibfk_1` FOREIGN KEY (`id_alunos`) REFERENCES `alunos` (`id`),
  ADD CONSTRAINT `reservas_ibfk_2` FOREIGN KEY (`id_computadores`) REFERENCES `computadores` (`id`);
COMMIT;
