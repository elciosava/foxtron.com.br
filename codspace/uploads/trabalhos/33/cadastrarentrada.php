...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: cadastrarentrada.php");
    exit;
}
}
...
<body>
<div class="container">
  <h1>Registrar Entrada de Peças</h1>
...
<form method="post">
      ...
      <button type="button" onclick="window.location.href='cadastrarsaida.php'">Registrar Entrada</button>
