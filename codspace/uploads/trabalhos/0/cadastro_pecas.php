...
<head>
    ...
    <style>
        * {
        ...
        body {
            background: linear-gradient(to right, rgba(2, 255, 86, 1), rgba(0, 255, 13, 1));
            font-family: Verdana;
        ...
        .form-box {
            ...
            border: 3px solid rgba(11, 241, 134, 1);
            border-radius: 10px;
            padding: 20px;
        ...
        button {
            background-color: rgba(5, 255, 80, 1);
            border: none;
            padding: 8px;
            border-radius: 5px;
            cursor: pointer;
        ...
        button:hover {
            background-color: rgba(196, 88, 0, 1);
        }
        .cabecalho {
            display: flex;
            padding: 0 20px;
