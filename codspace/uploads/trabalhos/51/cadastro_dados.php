...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO dados (nome, sobrenome, data_nascimento, telefone, email)
...
<head>
  ...
  <style>
    * {
    ...
    body {
      background: linear-gradient(135deg, #0dd2e0ff, #e2e3e4ff);
