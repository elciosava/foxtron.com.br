...
<body>
    ...
    if ($stmt->rowCount() > 0) {
        ...
        while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>
                    <form action='editar_materias.php' method='get' style='display:inline;'>
                        <input type='hidden' name='id' value='{$linha['id']}'>
                        <button type='submit'>Editar</button>
                    </form>
                    <form action='deletar_materias.php' method='post' style='display:inline;' onsubmit=\"return confirm('Deseja realmente deletar esta matéria?');\">
                        <input type='hidden' name='id' value='{$linha['id']}'>
        ...
        echo "<p style='color:white;'>Nenhuma matéria cadastrada.</p>";
    }
    ?>
</body>
</html>
