...
<head>
    ...
    <style>
        * {
        ...
        h2 {
            text-align: center;
            color: rgba(43, 67, 133, 1);
            margin-bottom: 20px;
            font-size: 1.8rem;
        }

        body {
            background: linear-gradient(to right, rgba(31, 53, 99, 1), rgba(88, 167, 241, 1));
            font-family: Verdana;
        ...
        .form-box {
            ...
            border: 3px solid rgba(40, 74, 124, 1);
            border-radius: 10px;
            padding: 20px;
        ...
        button {
            background-color: rgba(42, 62, 126, 1);
            border: none;
            padding: 8px;
            border-radius: 5px;
            cursor: pointer;
        ...
        button:hover {
            background-color: rgba(102, 151, 207, 0.66);
        }
