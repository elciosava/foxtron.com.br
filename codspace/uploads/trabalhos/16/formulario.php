    ...
    <section class="inicio">
        <div class="container">
            <form action="" method="post">
                ...
                <label for="pergunta3">3.Você sente que entende o que está sendo ensinado antes de passar para  próximo assunto?</label>
                ...
                <label for="pergunta6">6.Você sente que o professor e preocupa em verificar se todos estão entendendo?</label>
                ...
                <label for="pergunta12">12.O que você mais gosta de fazer nas aulas de programação?</label>
