        ...
        <div class="resultado">
            ...
            if ($stmt->rowCount() > 0) {
                ...
                while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<form action='deletar_produto.php' method='post' style='display:inline; margin-left:5px;'>";
                    echo     "<input type='hidden' name='id' value='{$linha['id']}'>";
                    echo "    <button type='submit' onclick=\"return confirm('Tem certeza que deseja deletar este produto?');\">Deletar</button>";
                    echo "  </form>";
