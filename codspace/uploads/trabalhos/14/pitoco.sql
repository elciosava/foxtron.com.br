...
(1, 1, 'auxiliar de gameplay de clash'),
(2, 2, 'testador de jogo  do roblox'),
(3, 3, 'gerenciador de v-bucks');
...
(1, 'Elcio sava sigma boy'),
(2, 'pedro betinha'),
(3, 'Luiz alpha'),
(4, 'Elcio sava sigma boy'),
(5, 'pedro betinha'),
(6, 'Luiz alpha'),
(7, 'felipe gordo'),
(8, ''),
