 ...
 <head>
    ...
    <title>Colinha para Prova</title>
    <style>
    body{
        margin:0;
        padding: 0;
 ...
 <body>
    ...
    <section id="sql">
        <div class="sql">
          ...
          <div class="texto">
            <h2>UPDATE</h2>
             <p>Função: Atualiza dados existentes em uma tabela.

             </p>
          </div>

           <div class="quadrinho">
            <p><h3>Exemplo:</h3> UPDATE clientes SET coluna 1 = valor1 WHERE condição;</p>
           </div>
    ...
    <section id="sql">
        <div class="sql">
          ...
          <div class="texto">
            <h2>CREATE</h2>
             <p>Função: Criar uma  tabela no banco de dados,por regra o primeiro
                campo deve ser unico na tabela.
...
<section id="sql">
        <div class="sql">
          ...
          <div class="texto">
            <h2>VARIAVEIS</h2>
             <p>Função: VARIAVEIS podem ser usadas de duas formas principais, com uma informaçao ja carregada no proprio programa ou recebendo
                informações de algum campo ou formulario.
    ...
    <section id="sql">
        <div class="sql">
          ...
          <div class="texto">
            <h2>CONEXAO</h2>
             <p>Função: O arquivo de conexão serve para fazer a ligação entre o programa e o banco de dados.
                Utiliza 4 variaveis principais:
