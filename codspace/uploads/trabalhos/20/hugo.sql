...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Out-2025 às 21:08
...
(1, 'Travessa', 'ceci vargas', '123', 'São Pedro', 'Porto Uniao', 'SC');
...
(4, 'pc gamer', 1, 4500),
(5, 'teclado da Redragon', 1, 249),
(6, 'Clube Fortnite', 1, 38),
(7, NULL, NULL, NULL),
(8, NULL, NULL, NULL);
...
(1, 'hugo', 'alfred', 'hugo@hugo', '123'),
(2, 'hugo', 'alfred', 'hugo@hugo', '1234'),
(3, 'hugo', 'alfred', 'hugo@hugo', '12312'),
(4, 'hugo', 'alfred', 'hugo@hugo', '12312'),
(5, 'hugo', 'alfred', 'hugo@hugo', '123');
