    ...
    <section class="inicio">
        <div class="container">
            <form action="" method="post">
                ...
                <label for="pergunta1">1. O conteudo das aulas é apresentada de 
                ...
                <label for="pergunta2">2. O ritmo das explicações esta adequado para o
                ...
                <label for="pergunta3">3. Voce sente que entende o que esta sendo 
                                          ensinado antes de passar para o proximo assunto?</label>
                ...
                <label for="pergunta4">4. O professor explica o conteudo de maneira
                                          que voce compreende com facilidade?</label>
                ...
                <label for="pergunta5">5. O professor responde as duvidas dos alunos de
                                          maneira atenciosa?</label>
                ...
                <label for="pergunta6">6. Voce sente que o professor se preocupa 
                                          em verificar se todos estao entendendo?</label>
                ...
                <label for="pergunta11">11. Como voce se sente para tirar duvidas com o
                                            professor?</label>
                ...
                <label for="pergunta13">13. O que poderia ser melhorado nas aulas ou 
                                            nas explicações?</label>
                <textarea name="pergunta13" id=""></textarea>

                <label for="pergunta14">14. Há algum assunto ou linguagem que voce gostaria
                                            que fosse mais explorada?</label>
                <textarea name="pergunta14" id=""></textarea>

                <label for="pergunta15">15. Deixe aqui qualquer outra sugestão ou 
                                            comentario.</label>
