    ...
    <title>Document</title>
     <style>
         * {
         ...
         body {
            background: linear-gradient(to top, rgba(44, 4, 99, 1), rgba(255, 255, 255, 1));
            font-family: Verdana;
         ...
         .form-box {
            background-color: rgba(167, 153, 202, 0.83);
            border: 3px solid rgba(0, 0, 255, 0.34);
            border-radius: 10px;
            padding: 20px;
         ...
         button {
            background-color: rgba(33, 39, 201, 0.34);
            border: none;
            padding: 8px;
            border-radius: 5px;
            cursor: pointer;
