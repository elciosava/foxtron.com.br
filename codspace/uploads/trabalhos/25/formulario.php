...
file_put_contents("resposta.txt",$texto, FILE_APPEND);
    ...
    <section class="inicio">
        <div class="container">
            <form action="" method="post">
                ...
                <label for="pergunta2">2. O ritmo das explicações esta adequada para o seu nivel de aprendizado?</label>
                ...
                <label><input type="radio" name="pergunta4" Value="Tenho dificuldade na maiorias das aulas">Tenho dificuldade na maioria das aulas</label>
                ...
                <label for="pergunta15">15. Deixe aqui qualquer outra sugestão ou comentario.></textarea>
