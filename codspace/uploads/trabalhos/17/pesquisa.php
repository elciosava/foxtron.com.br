    ...
    <section class="inicio">
        <div class="container">
            <form action="" method="post">
                ...
                <label><input type="radio" name="pergunta4" value="Tenho dificuldade na maioria das vezes">Tenho dificuldade na maioria das vezes</label>
                ...
                <label><input type="radio" name="pergunta8" value="Equilibrio entre pratica e teoria">Equilibrio entre pratica e teorica</label>
                ...
                <label for="pergunta14">14. Há algum assunto ou linguagem que voce gostaria que voce mais explorada?</label>
