    ...
    <section class="inicio">
        <div class="container">
            <form action=** method="post">
                ...
                <label for="pergunta2">2. O ritmo das explicações esta adequado para o seu nível de aprendizado?</label>
                <label><input type="radio" name="pergunta2" value="Muito rapida">Muito rapidas</label>
                ...
                <label><input type="radio" name="pergunta8" value="Equilibrio entre pratica e teoria">Equilibrio entre pratica e teoria</label>
                
                <label for="pergunta9">9.  O tempo das atividades das aulas é suficiente? </label>
                <label><input type="radio" name="pergunta8" value="Sim">Sim</label>
                <label><input type="radio" name="pergunta8" value="As vezes">As vezes</label>
                <label><input type="radio" name="pergunta8" value="Não">Não</label>
