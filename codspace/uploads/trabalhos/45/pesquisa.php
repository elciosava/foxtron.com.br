<?php 
if($_SERVER)['REQUTEST_methodo'] === 'POST';
...
file_put_contents("repostas.txt", $texto, FILE_APPEND);

echo "Respoosta salva com sucesso!"
    ...
    <section class="inicio">
        <div class="container">
            <form action="" method="post">
                <label for="pergunta1">1. o conteudo das aulas e apresentado de forma clara e organizada?.</label>
                ...
                <label><input type="radio" name="pergunta2" value="Muito rapido">Muito rapido</label>
                ...
                <label><input type="radio" name="pergunta4" value="Tenho dificuldades na maioria das vezes">Tenho dificuldades na maioria das vezes</label>
                ...
                <label><input type="radio" name="pergunta5" value="Nunca">Nunca</label>
                    ...
                    <label for="pergunta6">6. Voce sente que o preofessor se preocupa em vereficar se todos estao entendendo?.</label>
                ...
                <label><input type="radio" name="pergunta7" value="Não ajudam">Não ajudam</label>
                   ...
                   <label for="pergunta8">8. Voce prefere mais aulas praticas...?.</label>
                <label><input type="radio" name="pergunta8" value="Aulas praticas">Aulas praticas</label>
                <label><input type="radio" name="pergunta8" value="Aula teoricas">Aula teoricas</label>
                ...
                <label for="pergunta12">12. O que voce gosta nas aulas de programação?</label>
                ...
                <label for="pergunta14">14. Há algum assunto ou linguagem que voce gostaria que fosse mais explorados?</label>
