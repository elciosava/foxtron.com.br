...
function Ship(pos, r) {
  ...
  this.hits = function(asteroid) {
    ...
    // verifica os escudos levantados 
    if (this.shields > 0) {
      return false;
    }

    // verifica a distancia da nave ate o asteroid
    ...
    // verifica se a nave esta dentro do asteroid
    if (dist2 <= asteroid.rmin2) {
      return true;
    }

    // senao, precisamos verificar a interseção da linha
    var vertices = [
