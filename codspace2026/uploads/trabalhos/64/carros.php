...
<input type="text" name="marca_carro" placeholder="Marca">
<input type="text" name="modelo_carro" placeholder="Modelo">
<input type="number" name="ano_carro" placeholder="Ano">
<input type="text" name="placa_carro" placeholder="Placa">
...
<?php
        ...
        if ($stmt->rowCount() > 0) {
            echo "<div class='cabecalho'>";
             ...
             echo "<div class='cel_cabecalho'>Ação</div>";
             echo "</div>";
