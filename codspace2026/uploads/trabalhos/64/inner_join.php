...
$sql = "SELECT c.nome_cliente, e.rua_endereco FROM `cliente` AS c INNER 
    JOIN endereco AS e WHERE c.id_cliente = e.id_cliente";
...
<head>
    ...
    <style>
        *{
        ...
        .cel_cabecalho {
            width: 250px;
            border: 1px solid rgba(34, 22, 148, 0.4);
            padding: 5px;
        }
        .linha {
            width: 500px;
...
<body>
    <form action="salvar_cliente.php" method="post"></form>
    <select name="id_cliente" id="">
        ...
        <option value=""><?php $cliente['id_cliente'];?>"
            ...
            <?php endforeach; ?>
    <label for="rua_endereco">rua_endereco</label>
    <input type="text" class="rua_endereco" id="">
