...
<head>
    ...
    <title>Vala minha Nossa Senhora</title>
    <style>
        *{
            margin: 0;
            padding: 0;
...
<body>
    ...
    <form action="" method="post">
            ...
            <label for="modelo_carr">Modelo do Carro:</label>
            <input type="text" id="modelo_carro" name="modelo_carro">

            <label for="ano_carro">Ano da Carro:</label>
            <input type="number" id="ano_carro" name="ano_carro">
                ...
                while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
                    echo "<div class='linha'>";
                        ...
                        echo "<div class='cel_cabecalho'>";
                            ...
                            echo "<button type='submit'>Virou Sucata</button>";
                            echo "</form>";
                        echo "</div>";
                    echo "</div>";
