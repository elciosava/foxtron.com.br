...
const coursesData = {
    instalacao: {
        title: 'Instalação de Acessórios Automotivos',
    ...
    jovem_aprendiz: {
        title: 'Jovem Aprendiz Automotivo',
    ...
    injecao: {
        title: 'Sistemas de Injeção Eletronica Automotiva',
    ...
    eletroeletronica: {
        title: 'Eletroeletrônica Automotiva',
    ...
    mulheres: {
        title: 'Mecânica Automotiva para Mulheres',
        description: 'Suporte e Manutenção de Computadores',
        primaryColor: '#d80b81',
        accentColor: '#ff6b35',
        icon: '💾',
    ...
    diagnostico: {
        title: 'Diagnostico em Motores de Combustao Interna',
        description: 'Suporte e Manutenção de Computadores',
        primaryColor: '#021c7e',
        accentColor: '#ff6b35',
        icon: '💾',
    ...
    eletrica: {
        title: 'Sistema de Eletrica Automotiva',
        description: 'Suporte e Manutenção de Computadores',
        primaryColor: '#021c7e',
        accentColor: '#ff6b35',
        icon: '💾',
