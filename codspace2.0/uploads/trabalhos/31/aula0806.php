...
<body>
    ...
    <section id="select">
        <div class="texto-select">
            ...
            <p>O comando select é utilizado para consultar e visualizar dados armazenados em uma tabela de banco de dados. Ele não altera nenhuma informação, apenas retorna os registros que atemdem aos criterios informados.</p>
            <p>é um dos comandos mais utilizador do SQL, pois permite buscar 
            informações especificas, filtar resultados e organizar dados.
            </p>
        </div>
    ...
    <section id="insert">
        <div class="texto-select">
            ...
            <p>
                O comando INSERT é utilizado para adicionar novos regitros 
