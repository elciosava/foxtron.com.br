...
<body>
    ...
    <section id="select">
        <div class="texto-select">
            ...
            <p>
                O comando SELECT é utilizado para consultar e visualizar 
        ...
        <div class="consulta-sql">
            ...
            <div class="linha"><span>4 <span class="comentario">//SELECT que consuta colunas especificas</span></span></div>
