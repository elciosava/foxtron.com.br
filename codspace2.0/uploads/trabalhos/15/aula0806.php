...
<body>
        ...
        <div class="texto-select">
         ...
         <div class="consulta-sql">
            <div class="cabecalho">
              ...
              <div class="linha">
            <span>1 </span><span> //DELETE usamos para excluir</span><br>
            <span>2 </span><span> <span class="azul">DELETE * FROM </span>nome_da_tabela </span><br>
            <span>3 </span><span> <span class="azul">WHERE</span> condição </span>
        </div>
    ...
    <section id="insert">
        <div class="texto-select">
            ...
            <p>
                tambem é possível fazer a inserção de vários registros de uma unica vez
            </p>
        </div>
        ...
        <div class="linha" style="padding: 10px: 10px;">
