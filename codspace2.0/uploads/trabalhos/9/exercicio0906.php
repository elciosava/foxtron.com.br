...
<body>
    <form action="gravar_cliente.php" method="post">
        ...
        <input type="text" nome="nome_cliente" id="">

        <label for="nome_cliente">email</label>
        <input type="email" nome="email_cliente" id="">

        <label for="nome_cliente">senha</label>
        <input type="password" nome="senha_cliente" id="">
