...
<body>
    ...
    <section id="select">
        <div class="texto-select">
            ...
            <P>
                O comando SELECT é ultilizado para consultar e visualizar
            ...
            <p>
                É um dos comandos mais ultilizados em SQL, pois permite buscar
    ...
    <section id="insert">
        <div class="texto-select">
            ...
            <P>
                O comando INSERT é ultilizado para adicionar novos registros
                em uma tabela de banco de dados. Sempre que um novo dado precisa
                ser armazenado, ultiliza-se o comando INSERT.
            </P>
            <p>
                Tambem é possivel fazer a inserção de varios registros de uma unica vez.
            </p>
        </div>
        ...
        <div class="consulta-sql">
            ...
            <div class="linha" style="padding: 10px;">
                ...
                <span>2 </span><span> <span class="azul">INSERT INTO</span>nome_da_tabela (conluna1, coluna2, coluna3)</span><br>
