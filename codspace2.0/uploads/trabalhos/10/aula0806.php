...
<body>
    ...
    <section id="select">
        <div class="text-select">
            ...
            <p>O comando Select é utilizado para consultar e vizualizar dados armazenados em uma tabela de banco de dados. Eles não altera nemhuma informação, apenas retorna os registros que atendem aos criterios informados.</p>
            <p>É um dos comandos mais utilizados em SQL, pois permite buscar informaçoes especificas, filtrar resultados e organizar dados retornados.</p>
        </div>
        ...
        <div class="consulta-sql">
            ...
            <div class="linha"><span>2 <span><span class="azul">SELECT * FROM nome_da_tabela</span></span></div></span>
    ...
    <section id="delete">
        <div class="text-select">
            ...
            <p>O comando DELETE é  utilizado para remover registros de uma tabela do banco de dados. Diferente do comando SELECT, que apenas consulta informaçoes, o DELETE exclui dados permanentemente.</p>
            <p>É  importante ter cuidado ao utilizar esse comando principalmente quando na há filtros, muitos registros podem ser removidos de uma vez só</p>
        </div>
    ...
    <section id="insert">
        <div class="text-select">
            ...
            <p>
                O comando INSERT é utilizado para adicionar novos registros eu uma tabela do banco de dados. Sempre que um novo dado precisa ser armazenado, utiliza-se o comando INSERT.
            </p>
            <p>
        ...
        <div class="consulta-sql">
            ...
            <div class="linha" style="padding: 10px;">
                <span>1 </span><span class="comentario"> //Exemplos de INSERT</span><br>
