    ...
    <section id="select">
        ...
        <div class="consulta-sql">
            <div class="cabecalhio">
                <h2>Exemplo de comando INSERT</h2>
            </div>
    ...
    <section id="delete">
       ...
       <section id="insert">
        <div class="texto-select">
            ...
            <p>
               Tambem e possivel fazer a inserção de varios registros de uma unica vez.
            </p>
        </div>
        ...
        <div class="consulta-sql">
            ...
            <div class="linha" style="padding: 10px;">
                 ...
                 <span>3 </span><span> <span class="azul">VALURES</span> ('valor1', 'valor2', 'valor3')</span>
            </div>
        </div>
    </section>
