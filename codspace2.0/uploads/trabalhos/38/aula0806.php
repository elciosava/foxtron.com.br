...
<body>
   ...
   <section id="select">
    ...
    <div class="consulta-sql">
        ...
        <div class="linha"><span>1 <span class="comentario">//SELECT que consulta tudo</sapn></span></div>
   ...
   <section id="delete">
    <div class="texto-select">
        ...
        <p> O comando DELETE é ultilizado para remover registros
            de uma tabela do banco de dados. Disferente de comandos SELECT,
    ...
    <div class="consulta-sql">
        <div class="cabecalho">
         ...
         <div class="linha" style="height: 10px;"><span><span></span></span></div>
        <div class="linha"><span>1 <span class="comentario">//DELETE usamos para excluir</sapn></span></div>
   ...
   <section id="insert">
    <div class="texto-select">
        ...
        <p> O comando INSERT é utilizado para adicionar novos registros
            em uma tabela do banco de dados. Sempre que um novo dado 
            precisa ser armazenado, utiliza-se o comando INSERT. 
        </p>
        <p>
          Também é possível fazer a inserção de varios registro de uma unica vez.
        </p>
    ...
    <div class="consulta-sql">
        ...
        <div class="linha" style="padding: 10px;">
            <span>1 </span><sapn><span class="comentario"> //Exemplo de INSERT</sapn><br>
